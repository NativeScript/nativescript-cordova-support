...
; (function () {
    ...
    define("cordova", function (require, exports, module) {
        ...
        // var m_window_addEventListener = global.addEventListener;
        // var m_window_removeEventListener = global.removeEventListener;
        ...
        // global.addEventListener = function (evt, handler, capture) {
        //     var e = evt.toLowerCase();
        ...
        // global.removeEventListener = function (evt, handler, capture) {
        //     var e = evt.toLowerCase();
        //     // If unsubscribing from an event that is handled by a plugin
        //     if (typeof windowEventHandlers[e] !== 'undefined') {
        ...
        var cordova = {
            ...
            /**
             * Methods to add/remove your own addEventListener hijacking on document + global.
             */
    ...
    define("cordova/exec", function (require, exports, module) {
        ...
        //     console.log("******************************** calling activityStartedEvent event..*******************************");
        ...
        const pluginMng = new org.apache.cordova.PluginManager(application.android.foregroundActivity);
        pluginMng.init();
                ...
                try {
                    ...
                    if (callback) {
                        if (status === cordova.callbackStatus.OK) {
                            callback.success && callback.success(args);
                        } else {
                            callback.fail && callback.fail(args);
                        }

                    }
                } catch (err) {
                    const msg = 'Error in callbackId: ' + callbackId + ' : ' + err;
                    console.log(msg);
                    throw err;
                }
            }
        ...
        function androidExec(success, fail, service, action, args) {
            ...
            console.log(" pluginMng.exec ..." )
            pluginMng.exec(service, action, callbackContext, argsJson)
        }
        ...
        // events).
        // global.addEventListener('online', pollOnceFromOnlineEvent, false);
        // global.addEventListener('offline', pollOnceFromOnlineEvent, false);
        ...
        //     if (mode == jsToNativeModes.JS_OBJECT && !global._cordovaNative) {
        ...
        //         payload.push(global.atob(message.slice(1)));
    ...
    define("cordova/init", function (require, exports, module) {
        ...
        if (global.navigator) {
            global.navigator = replaceNavigator(global.navigator);
        }
