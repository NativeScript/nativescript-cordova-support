...
const navigator = {
    ...
    userAgent : "NativeScript for iOS"
};
...
define("cordova", function(require, exports, module) {
    ...
    var cordova = {
        ...
        addWindowEventHandler : function(event) {
            // console.log("Unsupported Cordova JS function `addWindowEventHandler`.");
            return (windowEventHandlers[event] = channel.create(event));
        },
        addStickyDocumentEventHandler : function(event) {
            // console.log("Unsupported Cordova JS function `addStickyDocumentEventHandler`.");
            return (documentEventHandlers[event] = channel.createSticky(event));
        },
        addDocumentEventHandler : function(event) {
            // console.log("Unsupported Cordova JS function `addDocumentEventHandler`.");
            return (documentEventHandlers[event] = channel.create(event));
        },
        removeWindowEventHandler : function(event) {
            // console.log("Unsupported Cordova JS function `removeWindowEventHandler`.");
            delete windowEventHandlers[event];
        },
        removeDocumentEventHandler : function(event) {
            // console.log("Unsupported Cordova JS function `removeDocumentEventHandler`.");
        ...
        getOriginalHandlers : function() {
            console.log("Unsupported Cordova JS function `getOriginalHandlers`.");
        ...
        fireDocumentEvent : function(type, data, bNoDetach) {
            console.log("Unsupported Cordova JS function `fireDocumentEvent`.");
        ...
        fireWindowEvent : function(type, data) {
            console.log("Unsupported Cordova JS function `fireWindowEvent`.");
            // var evt = createEvent(type, data);
    ...
    global.cordova = window.cordova = cordova;
...
define("cordova/exec", function(require, exports, module) {
    ...
    function iOSExec() {
        ...
        var command = CDVInvokedUrlCommand.alloc()
                          .initWithArgumentsCallbackIdClassNameMethodName(
                              actionArgs, callbackId, service, action);

        CDVViewController.instance().commandQueue.execute(command);
    ...
    function pokeNative() {
        console.log("Unsupported Cordova JS function `exec.pokeNative`.");
    ...
    iOSExec.nativeFetchMessages = function() {
        //        console.log("Unsupported Cordova JS function `iOSExec.nativeFetchMessages`.");
...
define("cordova/pluginloader", function(require, exports, module) {
    ...
    function findCordovaPath() {
        console.log("Unsupported Cordova JS function `pluginloader.findCordovaPath`.");
...
define("cordova/urlutil", function(require, exports, module) {
    ...
    exports.makeAbsolute = function makeAbsolute(url) {
        console.log("Unsupported Cordova JS function `urlutil.makeAbsolute`.");
